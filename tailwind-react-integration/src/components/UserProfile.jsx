function UserProfile() {
    return (
      <div className="user-profile bg-gray-100 p-8 md:max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:p-4 md:p-8 max-w-xs hover:shadow-xl">
        ...
        <h1 className="md:text-xl text-blue-800 my-4 text-lg hover:text-blue-500">John Doe</h1>
